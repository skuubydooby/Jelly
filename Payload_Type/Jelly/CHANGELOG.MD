...
- Updated screenshot and screenshot_topp to not send extra file_ids to user output since PutFile does that automaically

## [v2.3.42] - 2025-07-24

### Changed

- Updated the screenshot_topp processing to use donut PyPi package
...
- Fixing keylog_topp
  - adding keylog_topp browser script to go with it for basic conversion
...
- Updated execute_coff, execute_assembly, inline_assembly, execute_pe, inline_assembly, and assembly_topp
...
- Updated the build for coffee.dll
...
- Updated execute_coff to copy coffee.dll instead of move it as needed
...
- Fixed an issue with the topp command trying to auto-issue a follow-on link for p2p-based shellcode
...
- Removed RunOF and replaced it with TrustedSec's coffee project
- Adjusted the execute_coff command to pack args instead of sending down a typed array
- Added a reflective loader for the coffee.dll (with Claude)
...
- updated execute_assembly topped stub to hopefully capture more output successfully
